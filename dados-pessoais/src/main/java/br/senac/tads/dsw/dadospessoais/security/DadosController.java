...
public class DadosController {
    ...
    public record UsuarioSistemaDto(String username, String nomeCompleto,  String hashSenha) {

        public UsuarioSistemaDto(UsuarioSistema usuario) {
            this(usuario.getUsername(), usuario.getNomeCompleto(), usuario.getHashSenha());
        }
